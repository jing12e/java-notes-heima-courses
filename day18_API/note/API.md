...
查看API文档，我们可以看到API文档中关于Math类的定义如下：
 ...
 ![1576047659085](1576047659085.png) 
...
![1576047846672](1576047846672.png) 
...
查看API文档，我们可以看到API文档中关于System类的定义如下：
 ...
 ![1576049347968](1576049347968.png) 
...
![1576049535584](1576049535584.png) 
...
![1576053677194](1576053677194.png) 
...
![1576053871503](1576053871503.png) 
...
![1576055135105](1576055135105.png) 

2. 选择toString，此时会弹出如下的对话框

![1576055198877](1576055198877.png) 
...
1. 在空白处使用快捷键：alt + insert。此时会弹出如下的对话框
 ...
 ![1576056718392](1576056718392.png) 

2. 选择equals() and hashCode()方法，此时会弹出如下的对话框

![1576057779458](1576057779458.png) 

点击next，会弹出如下对话框：

![1576057813175](1576057813175.png) 

选择neme和age属性点击next，此时就会弹出如下对话框：

![1576057892814](1576057892814.png) 
...
![1576058492444](1576058492444.png) 
...
![1576058659628](1576058659628.png) 
...
public static boolean isNull(Object obj)					// 判断对象是否为null，是null返回true
public static boolean nonNull(Object obj)					// 判断对象是否不为null，为null返回false
```
...
查看API文档，我们可以看到API文档中关于BigInteger类的定义如下：
 ...
 ![Snipaste_2022-09-04_21-36-01](Snipaste_2022-09-04_21-36-01.png)
...
查看API文档，我们可以看到API文档中关于BigDecimal类的定义如下：
 ...
 ![1576132679789](1576132679789.png)
